...
penguin.chirp = function(){console.log("CHIRP CHIRP!");}
console.log(penguin.chirp());
...
penguin.sayHello = function(){console.log(this.character);}
...
var keys = [];
for (var i in penguin) keys.push(i);
console.log(keys)
...
var values = [];
for (var i in penguin) values.push(penguin[i]);
console.log(values);
